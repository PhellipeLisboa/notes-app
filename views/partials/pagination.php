<div class="rounded-lg bg-gray-900 px-4 py-1 mt-4 sm:px-6">

    <form action="/notes" method="POST">
        <input type="hidden" name="_method" value="GET">

        <div class="flex items-center justify-between  rounded-lg bg-gray-900 px-4 py-0 mt-4 sm:px-6">

            <div>
                <label for=" elements_per_page" class="block mb-2 text-sm font-medium text-white dark:text-white">Itens
                    per
                    page:</label>
