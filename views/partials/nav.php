                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="ml-3">
                        <form action="/session" method="POST">
                            ...
                            <button
                                class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-4 py-2 text-sm font-medium">Log
                                out</button>
        ...
        <div class="md:hidden" id="mobile-menu">
            ...
            <div class="border-t border-gray-700 pb-3 pt-4">
                <div class="flex items-center px-5">
                    <div class="flex-shrink-0">
                        <img class="h-10 w-10 rounded-full border-white border-2"
                            src="https://openclipart.org/download/247319/abstract-user-flat-3.svg" alt="">
                    </div>
                    <div class="ml-3">
