...
<main>
    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <img class="mx-auto h-10 w-auto" src="https://openclipart.org/download/247319/abstract-user-flat-3.svg"
                alt="Your Company">
        ...
        <div class="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-2" action="/session" method="POST">
                ...
                <p class="text-neutral-700 text-sm">Don't have an account? <a href="/register"
                        class="text-blue-700 hover:underline">Register</a></p>
